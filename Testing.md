...
## Introduction
This document outlines the testing strategy, test requirements, and test cases for our software application. The project follows a Test-Driven Development (TDD) methodology to ensure all functional requirements are met and uses JUnit for test case management. The application is built using the Model-View-Controller (MVC) architecture to ensure proper separation of concerns, which is reflected in our integration testing strategy.

## Testing Metrics and Justification
*To ensure a robust and systematically evaluated design, the following metrics are used for design selection and testing:*
...
*Briefly explain how your test suite helps validate the four design constraints you chose for the project (Economic, Regulatory, Reliability, Sustainability, Ethics, or Societal) .*
...
## 1. Function Testing
*The following function was chosen from the application to demonstrate path and data flow testing*
...
*Testing interactions within the MVC architecture.*

* **Subset of Units Tested:** [List the specific Model, View, or Controller units chosen for integration testing]
...
*The following techniques are used to validate the application's functionality*
...
* **Equivalence Classes:** * *Valid Classes:* [Explicitly state valid ranges/types]
  * *Invalid Classes:* [Explicitly state invalid ranges/types]
* **Test Cases:**
...
* **Target Use Case:** [Explicitly describe the use cases being tested]
...
* **Execution Status:** All test cases in the test suite have been executed.
* **Output Verification:** All actual outputs were compared with the expected outputs, successfully demonstrating the basic functionality of the detailed final design.